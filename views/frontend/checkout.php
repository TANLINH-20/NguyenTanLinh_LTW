            ...
            <form action="index.php?option=checkout" method="post">
               ...
               <?php if (isset($_SESSION["iscustom"])) : ?>
                  ...
                  <div class="mb-3">
                     ...
                     <input type="text" name="phone" value="<?= $customer->phone; ?>" id="phone" class="form-control" placeholder="Nhập điện thoại" readonly>
                  </div>
                  <div class="mb-3">
                     <label for="email">Email</label>
                     <input type="text" name="email" value="<?= $customer->email; ?>" id="phone" class="form-control" placeholder="Nhập điện thoại" readonly>
                  </div>
                  <div class="mb-3">
