               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" placeholder="Nhập tên danh mục" class="form-control" onkeydown="handle_slug(this.value);" required>
                     </div>
                     <div class="mb-3">
                        <label>Slug</label>
                           ...
                           <?php if (count($list) > 0) : ?>
                              <?php foreach ($list as $item) : ?>
                                 <tr class="datarow">
                                    ...
                                    <td>
                                       <img style="width:100px" src="../public/images/category/<?= $item->image; ?>" alt="<?= $item->image; ?>">
                                    </td>
                                    <td>
                                       <div class="name">
                                          <?= $item->name; ?>
